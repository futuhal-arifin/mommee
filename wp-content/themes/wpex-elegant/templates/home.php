	...
	<div id="primary" class="content-area clr">
		<div id="content" class="site-content" role="main">
			<?php while ( have_posts() ) : the_post(); ?>
				<article class="left-content clr">
					<?php
					/**
						Post Content
					**/ ?>
					...
					**/
					...
					/**
						Blog
					**/
					$display_count = get_theme_mod('wpex_home_blog_count', '6');
					$wpex_query = new WP_Query(
						array(
							'post_type'			=> 'post',
							'posts_per_page'	=> $display_count,
					...
					if ( $wpex_query->posts ) { ?>
						<div id="homepage-blog" class="clr">
							<h2 class="heading"><span><?php _e( 'Artikel Terbaru', 'wpex' ); ?></span></h2>
							<?php $wpex_count=0; ?>
							<?php foreach( $wpex_query->posts as $post ) : setup_postdata( $post ); ?>
								<?php $wpex_count++; ?>
									<article class="recent-blog-entry clr col span_1_of_2 col-<?php echo $wpex_count; ?>">
										<?php
