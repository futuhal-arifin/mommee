        ...
        <article <?php post_class($current_post); ?>>
          ...
          <?php if ($instance['show_excerpt']) : ?>
            <div class="entry-summary">
              <p>
                <?php 
                  // To prevent conflict with upcoming events plugin. 
                  global $upcoming_events_lists;
                  remove_filter( 'the_content', array($upcoming_events_lists, 'upcoming_events_single_content') );
