...
?>
		...
		<div id="product-review">
			...
			<?php do_atomic( 'open_product_review' ); // origin_open_product_review ?>

			<div class="product-review-content">	
				<?php get_template_part( 'product-review' ); // Loads the product-review.php template. ?>
			</div>

			<?php do_atomic( 'close_product_review' ); // origin_close_product_review ?>
