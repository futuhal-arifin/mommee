     ...
     function huge_it_change_image_<?php echo $sliderID; ?>(current_key, key, data_<?php echo $sliderID; ?>, from_effect,clicked) {
        ...
        if (data_<?php echo $sliderID; ?>[key]) {
          ...
          if (huge_it_trans_in_progress_<?php echo $sliderID; ?>) {
			//errorlogjQuery(".hentry .huge_it_slideshow_image_wrap_<?php echo $sliderID; ?>").after(" --IN TRANSACTION-- <br />");
      ...
      function huge_it_popup_resize_<?php echo $sliderID; ?>() {
		...
		jQuery(".huge_it_slideshow_image_wrap_<?php echo $sliderID; ?>").css({height: ((sliderwidth) * str + 20)});
		jQuery(".huge_it_slideshow_image_container_<?php echo $sliderID; ?>").css({width: (sliderwidth)});
		jQuery(".huge_it_slideshow_image_container_<?php echo $sliderID; ?>").css({height: ((sliderwidth) * str + 20)});
	...
	.huge_it_slideshow_image_wrap_<?php echo $sliderID; ?> * {
	  ...
	  .huge_it_slideshow_description_text_<?php echo $sliderID; ?> {
		...
		<?php  if($paramssld['slider_description_has_margin']=='on'){
				$slider_description_width=($paramssld['slider_description_width']-1);
				$slider_description_height=($paramssld['slider_description_height']-1);
...
<div class="hentry huge_it_slideshow_image_wrap_<?php echo $sliderID; ?> nocolor">
<?php } else { ?>
<div class="hentry huge_it_slideshow_image_wrap_<?php echo $sliderID; ?> ">
<?php } ?>
	<?php if($sliderloadingicon == "on")	{ ?>
		...
		<div class="hentry huge_it_slideshow_image_wrap1_<?php echo $sliderID; ?> nodisplay">
	<?php } else { ?>
		...
		<div class="hentry huge_it_slideshow_image_wrap1_<?php echo $sliderID; ?>"class="display">
	<?php } ?>
      <?php
      $current_pos = 0;
      ?>
